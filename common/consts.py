...
colors_light = {
    ...
    "fg": "#1A1A1A",             # Почти чёрный (основной текст)
    "fg_light": "#454545",
    "borders": "#CCCCCC",        # Светло-серый (границы и разделители)
    "main_text": "#000000",      # Почти чёрный (основной текст)
    "secondary_text": "#000000", # Средне-серый (вторичный текст)
    "error": "#D32F2F",          # Тёмно-красный (ошибки, опасность)
    "success": "#388E3C",        # Тёмно-зелёный (успех, подтверждение)
    "warn": "#F57C00",           # Тёмно-оранжевый (предупреждения)
    "accent": "#41a700",         # Ярко-сине-зелёный (акцент)
    "accent_hover": "#6ba750",   # Светло-бирюзовый (hover акцент)
}